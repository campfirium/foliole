...
export function requiresWindowsDevDesktopBuild(action) {
  return ['device-profile', 'readwise-api-connection', 'readwise-api-import', 'sync-group-join-prepare'].includes(action)
...
export function windowsDevRequiredTools(action, paths) {
  ...
  const adbRequired = !['build', 'default-sync-journey', 'desktop-dnssd-host-facts',
    'device-profile', 'frozen-revision-preflight', 'readwise-api-connection', 'readwise-api-import',
