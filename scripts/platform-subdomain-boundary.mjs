...
const EXPLICIT_FILE_SUBDOMAINS = new Map([
  ...
  ['src/shared/platform/companionSyncGroupJoinClient.ts', 'companion-runtime-plugin'],
  ['src/shared/platform/companionSyncGroupJoinEncryption.ts', 'companion-runtime-plugin'],
  ...
  ['src/shared/platform/desktopSyncGroupOverviewHooks.ts', 'desktop-runtime-repository'],
  ['src/shared/platform/desktopSyncGroupRuntimeRepository.ts', 'desktop-runtime-repository'],
  ...
  ['src/shared/platform/folioleCliInstallation.ts', 'desktop-runtime-repository'],
  ...
  ['src/shared/platform/useDesktopSyncGroup.ts', 'desktop-runtime-repository'],
