...
import { assertFreshCredentialReceipt } from './macos-a5-pair-credentials-action.mjs';
import {
...
it('rejects any Leave drift or credential receipt that advances initial sync', () => {
  ...
  expect(() => assertFreshCredentialRejoinBaseline({
    ...departed, protectedContentDigest: 'b'.repeat(64)
  }, baseline)).toThrow('did not preserve');
