...
const DESKTOP_SCHEMA_FILES = {
  ...
  DESKTOP_SOURCE_SCHEMA_STATEMENTS: 'lib/core/database/desktopSourceSchemaStatements.ts',
  WATCHED_FOLDER_BINDING_SCHEMA_STATEMENTS: 'lib/core/database/desktopSourceConnectionSchemaStatements.ts',
