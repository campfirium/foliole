  ...
  return new Promise((resolve) => {
    const child = spawn('bash', [TARGET_SCRIPT, target], {
      ...
      env: {
        ...
        QUALITY_GATE_PARALLEL_MAX_JOBS: '16',
...
const FULL_GATE_SCRIPTS = {
  ...
  'test:quality:gate-integration': 'node -e "console.log(\'full quality gate integration test ok\')"',
  'test:quality:gate-integration:routing': 'node -e "console.log(\'full quality gate integration routing test ok\')"',
  'test:quality:gate-integration:fast-delegation': 'node -e "console.log(\'full quality gate integration fast delegation test ok\')"',
  'test:quality:gate-integration:targets': 'node -e "console.log(\'full quality gate integration targets test ok\')"',
  'test:quality:gate-integration:target-core': 'node -e "console.log(\'full quality gate integration target core test ok\')"',
  'test:quality:gate-integration:target-failures': 'node -e "console.log(\'full quality gate integration target failures test ok\')"',
  'test:quality:gate-integration:target-collect': 'node -e "console.log(\'full quality gate integration target collect test ok\')"',
  'test:quality:gate-integration:target-telemetry': 'node -e "console.log(\'full quality gate integration target telemetry test ok\')"',
  'test:quality:gate-integration:release-targets': 'node -e "console.log(\'full quality gate integration release targets test ok\')"',
...
const RELEASE_GATE_SCRIPTS = {
  ...
  'test:quality:gate-integration:routing': 'node -e "console.log(\'release quality gate integration routing test ok\')"',
  'test:quality:gate-integration:fast-delegation': 'node -e "console.log(\'release quality gate integration fast delegation test ok\')"',
  'test:quality:gate-integration:targets': 'node -e "console.log(\'release quality gate integration targets test ok\')"',
  'test:quality:gate-integration:target-core': 'node -e "console.log(\'release quality gate integration target core test ok\')"',
  'test:quality:gate-integration:target-failures': 'node -e "console.log(\'release quality gate integration target failures test ok\')"',
  'test:quality:gate-integration:target-collect': 'node -e "console.log(\'release quality gate integration target collect test ok\')"',
  'test:quality:gate-integration:target-telemetry': 'node -e "console.log(\'release quality gate integration target telemetry test ok\')"',
  'test:quality:gate-integration:release-targets': 'node -e "console.log(\'release quality gate integration release targets test ok\')"',
