...
describe('FolioleCompanionSync method inventory', () => {
  it('keeps TypeScript and Android plugin methods equal', async () => {
    ...
    expect(sortedUnique(extractJavaPluginMethods(javaSource))).toEqual(sortedUnique(typeScriptMethods));
  });
