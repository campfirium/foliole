export const CLASSIFICATIONS = {
  ...
  bridge_contract_metadata: {
    ...
    files: [
      ...
      'FolioleCompanionPairingSignatureContractDefinitions.java',
  ...
  bridge_plugin_adapter: {
    ...
    files: [
      ...
      'FolioleCompanionPluginWork.java',
  ...
  host_platform_adapter: {
    ...
    files: [
      ...
      'FolioleCompanionLatestServiceQueue.java',
      ...
      'FolioleCompanionPairingPreferenceCleaner.java',
      'FolioleCompanionPairingProtocolStore.java',
      'FolioleCompanionPairingStore.java',
      'FolioleCompanionPluginLifecycle.java',
      ...
      'FolioleCompanionSyncGroupLifecycleKeyStore.java',
