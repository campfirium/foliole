const ACTION_OVERRIDES = Object.freeze({
  ...
  's220-main-compare': { deviceLeaseMode: 'readonly-lifecycle',
    formalSourceClass: 'source-free-readonly', mutatesFixedA5: false },
  's220-group-inspect': { deviceLeaseMode: 'readonly-lifecycle',
    formalSourceClass: 'source-free-readonly', mutatesFixedA5: false },
  's220-network-status': { deviceLeaseMode: 'readonly-lifecycle',
    formalSourceClass: 'source-free-readonly', mutatesFixedA5: false },
  's220-upgrade': { formalSourceClass: 'ordinary-only' },
  's220-upgrade-test': { formalSourceClass: 'ordinary-only' },
  's220-offline-test-upgrade': { formalSourceClass: 'ordinary-only' },
  's220-resource-test-upgrade': { formalSourceClass: 'ordinary-only' },
  's220-final-test-upgrade': { formalSourceClass: 'ordinary-only' },
  's220-final-fixture': { formalSourceClass: 'ordinary-only',
    requiresHiddenDesktopRuntime: true },
  's220-offline': { formalSourceClass: 'ordinary-only',
    requiresHiddenDesktopRuntime: true },
  's220-offline-edit': { formalSourceClass: 'ordinary-only',
    requiresHiddenDesktopRuntime: true },
  's220-converge': { formalSourceClass: 'ordinary-only',
    requiresHiddenDesktopRuntime: true },
...
const MACOS_A5_ACTIONS = new Set([
  ...
  's220-package-inventory', 's220-main-compare', 's220-group-inspect',
  's220-network-status',
