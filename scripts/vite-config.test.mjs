...
describe('vite config', () => {
  ...
  it('builds Demo from its Web host root into its static output directory', () => {
    expect(demoViteConfig.base).toBe('/assets/demo/');
  ...
  it('emits the Demo manifest from public bundle asset names', () => {
    ...
    expect(manifest.publishedLocales.map((locale) => locale.locale)).toEqual([
      'en', 'de', 'es', 'fr', 'it', 'ja', 'ko', 'pl', 'pt', 'ru', 'zh-hans', 'zh-hant'
    ]);
