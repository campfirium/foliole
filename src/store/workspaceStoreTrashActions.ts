...
function createDeleteNodeAction(set: WorkspaceSet): WorkspaceTrashActions['deleteNode'] {
  return (nodeId) => {
    set((state) => {
...
function createRestoreNodeAction(set: WorkspaceSet): WorkspaceTrashActions['restoreNode'] {
  return (nodeId) => {
    set((state) => {
      if (!state.nodesById[nodeId] || !state.trashedNodeIds.includes(nodeId)) {
        return state;
...
function createDeleteNodePermanentlyAction(set: WorkspaceSet): WorkspaceTrashActions['deleteNodePermanently'] {
  return (nodeId) => {
    set((state) => {
...
export function createWorkspaceTrashActions(set: WorkspaceSet): WorkspaceTrashActions {
  return {
    deleteNode: createDeleteNodeAction(set),
    restoreNode: createRestoreNodeAction(set),
    deleteNodePermanently: createDeleteNodePermanentlyAction(set)
  };
}
