...
it('keeps sync and cleanup alongside automatic and manual import', async () => {
  ...
  expect(screen.getByRole('searchbox', { name: 'Search by title or author' })).toBeInTheDocument();
