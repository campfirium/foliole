...
export const IMMERSIVE_READING_SHORTCUTS: ImmersiveReadingShortcut[] = [
  ...
  { ariaKeyShortcuts: 'Space ArrowDown', key: 'Space / ArrowDown', summary: 'Select the next paragraph' },
  { ariaKeyShortcuts: 'Shift+Space ArrowUp', key: 'Shift+Space / ArrowUp', summary: 'Select the previous paragraph' },
