...
import { isEditableElement, ownsTextHistory } from './commandTextHistory';
...
function shouldSkipCommandShortcut(args: {
  ...
  if (isHistoryShortcut && (ownsTextHistory(args.event.target) || ownsTextHistory(document.activeElement))) {
    return true;
  }
