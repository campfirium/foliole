...
export function buildLayoutProps(args: BuildLayoutPropsArgs): WorkspaceLayoutProps {
  ...
  const flatProps: WorkspaceLayoutFlatProps = {
    ...
    onRevealAnswer: args.revealReviewAnswer, onResumeReviewItem: args.onResumeReviewItem, onGradeReview: (grade) => args.updateGrade(grade), onReadReviewTopic: () => args.readReviewTopic(), onPostponeReviewTopic: () => args.postponeReviewTopic(), onOpenPostponeTopicPanel: args.onOpenPostponeTopicPanel, onDismissReviewTopic: () => args.dismissReviewTopic(), onRevisitReviewTopicSoon: () => args.revisitReviewTopicSoon(), onContinueReading: createContinueReadingAction(args), onExitReviewMode: sessionActions.onExitReviewMode, onSetReviewSessionMode: (mode) => args.setReviewSessionMode(mode, args.nowIso),
