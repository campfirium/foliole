...
export function buildLayoutProps(args: BuildLayoutPropsArgs): WorkspaceLayoutProps {
  ...
  return {
    ...
    documentMaxWidth: args.documentMaxWidth, editorContent: args.documentNode?.content ?? '', isEditorReadOnly: args.activeNodeId ? isNodeContentLocked(args.activeNodeId, args.nodeOrder, args.nodesById) : false, editorNodeId: args.editorNodeId, editorNodeViewState: args.editorNodeViewState,
