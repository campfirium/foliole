...
export function buildLayoutProps(args: BuildLayoutPropsArgs): WorkspaceLayoutProps {
  ...
  const flatProps: WorkspaceLayoutFlatProps = {
    ...
    onRevealAnswer: args.revealReviewAnswer, onResumeReviewItem: args.onResumeReviewItem, onGradeReview: (grade) => args.updateGrade(grade), onReadReviewTopic: () => args.readReviewTopic(), onPostponeReviewTopic: () => args.postponeReviewTopic(), onOpenPostponeTopicPanel: args.onOpenPostponeTopicPanel, onShelveReviewTopic: () => args.shelveReviewTopic(), onDismissReviewTopic: () => args.dismissReviewTopic(), onRevisitReviewTopicSoon: () => args.revisitReviewTopicSoon(), onContinueReading: createContinueReadingAction(args), onExitReviewMode: sessionActions.onToggleReviewSession, onSetReviewSessionMode: args.setReviewSessionMode,
