...
export function buildLayoutProps(args: BuildLayoutPropsArgs): WorkspaceLayoutProps {
  ...
  return {
    ...
    isAnswerRevealed: args.reviewSession.isAnswerRevealed, isDocumentResizing: args.documentResize.isResizingDocument, isResizingList: args.isResizingList, isTrashViewOpen: args.isTrashViewOpen, isViewingTrashNode: args.isViewingTrashNode,
    ...
    onRevealAnswer: args.revealReviewAnswer, onGradeReview: (grade) => args.updateGrade(grade), customUiFont: args.appearance.customUiFont,
