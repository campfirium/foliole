...
export const ZH_HANS_DESKTOP_SOURCE_CONNECTION_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
  ...
  'desktop.watchedFolder.connections.otherDevices': '其他设备',
  'desktop.watchedFolder.connections.path': '路径',
  'desktop.watchedFolder.connections.deviceActions': '{device} 的更多操作',
  ...
  'desktop.readwise.device.title': '当前生效设备',
  'desktop.readwise.device.path': '路径',
  'desktop.readwise.device.unavailable': '设备不可用',
  'desktop.readwise.device.pathUnavailable': '路径不可用',
  ...
  'desktop.readwise.device.none': '尚未选择设备',
  'desktop.readwise.device.useThis': '使用此设备',
  'desktop.readwise.device.switch': '切换到本设备'
};
