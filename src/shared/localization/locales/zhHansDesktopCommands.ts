...
export const ZH_HANS_DESKTOP_COMMAND_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
  ...
  'desktop.command.openImportManagement': '打开导入管理',
  ...
  'desktop.command.flow.toggle': '切换流程模式',
  ...
  'desktop.command.review.readingSoon': '阅读：稍后',
  'desktop.command.review.readingLater': '阅读：以后',
  'desktop.command.review.postponeTopic': '推迟主题...',
  'desktop.command.review.read': '阅读：已读',
  'desktop.command.review.dismiss': '阅读：移出',
