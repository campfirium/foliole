...
export const ZH_HANS_SETTINGS_SYNC_GROUP_TRANSLATIONS: Partial<Record<TranslationKey, string>> = {
  ...
  'settings.companionSync.group.discovery.active_permission_required': '请允许访问本地网络，以重新连接此同步组中的设备。',
  'settings.companionSync.group.discovery.active_unavailable': 'Foliole 当前无法查找此同步组中的设备。',
  'settings.companionSync.group.discovery.macos_settings': '前往“系统设置 > 隐私与安全性 > 本地网络”允许 Foliole，然后重试。',
  'settings.companionSync.group.discovery.open_settings': '打开系统设置',
