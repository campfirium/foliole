export const EN_SETTINGS_SYNC_GROUP_TRANSLATIONS = {
  ...
  'settings.companionSync.group.discovery.active_permission_required': 'Allow Local Network access to reconnect devices in this Sync Group.',
  'settings.companionSync.group.discovery.active_unavailable': 'Foliole cannot find devices in this Sync Group right now.',
  'settings.companionSync.group.discovery.macos_settings': 'Open System Settings > Privacy & Security > Local Network, allow Foliole, then try again.',
  'settings.companionSync.group.discovery.open_settings': 'Open System Settings',
