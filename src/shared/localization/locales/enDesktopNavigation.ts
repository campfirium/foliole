export const EN_DESKTOP_NAVIGATION_TRANSLATIONS = {
  ...
  'desktop.workspace.restartFailed': 'Restart failed. Try again',
  'desktop.workspace.restarting': 'Restarting… This may take a moment.',
  ...
  'desktop.workspace.appearanceMode.current': 'Appearance mode: {mode}',
  ...
  'desktop.splitTopic.complete': 'Topic split.',
  'desktop.splitTopic.confirm': 'Split Topic',
  'desktop.splitTopic.delimiter': 'Delimiter',
  'desktop.splitTopic.description':
    'Preview the new Topics before replacing the current Topic with split results.',
  'desktop.splitTopic.enterDelimiter': 'Enter a delimiter to preview the new Topics.',
  ...
  'desktop.splitTopic.replace': 'Replace',
  'desktop.splitTopic.noPreview': 'No Topics will be created from this delimiter.',
  'desktop.splitTopic.preview': 'Preview',
  'desktop.splitTopic.splitting': 'Splitting...',
  'desktop.splitTopic.title': 'Split Topic',
  ...
  'desktop.rightPanel.assistant.placeholder': 'Enter a question or task...',
  ...
  'desktop.rightPanel.assistant.followCurrentMaterial': 'Attach the current topic or folder',
  'desktop.rightPanel.assistant.followingCurrentMaterial': 'Will attach: {title}',
