...
export const APP_SETTINGS_STORAGE_KEYS = {
  ...
  mouseGesturesEnabled: 'foliole-mouse-gestures-enabled',
  mouseGestureBindings: 'foliole-mouse-gesture-bindings-v1',
  mouseGestureTrailVisible: 'foliole-mouse-gesture-trail-visible',
  mouseGestureHintVisible: 'foliole-mouse-gesture-hint-visible',
  ...
  externalFoldersEnabled: 'foliole-external-folders-enabled',
  ...
  globalClipExistingClipboardFallbackEnabled:
    'foliole-global-clip-existing-clipboard-fallback-enabled',
  globalClipHintVisible: 'foliole-global-clip-hint-visible',
  globalClipToastPosition: 'foliole-global-clip-toast-position',
  ...
  feedbackRememberedContact: 'foliole-feedback-remembered-contact',
