...
const floatingInputBaseClassName = [
  'w-full appearance-none border-x-0 border-t-0 border-b border-[color-mix(in_srgb,var(--app-floating-divider-color)_55%,transparent)] bg-[var(--app-floating-input-bg)] px-4 py-3 text-ui-md text-foreground shadow-none outline-none [box-shadow:none]',
  'focus:border-[color-mix(in_srgb,var(--app-floating-divider-color)_55%,transparent)] focus:outline-none focus:ring-0 focus:shadow-none focus:[box-shadow:none] focus:[outline:0]',
  'focus-visible:border-[color-mix(in_srgb,var(--app-floating-divider-color)_55%,transparent)] focus-visible:outline-none focus-visible:ring-0 focus-visible:shadow-none focus-visible:[box-shadow:none] focus-visible:[outline:0]',
