...
const LOCAL_STORAGE_WHITELIST = new Set<string>([
  ...
  APP_SETTINGS_STORAGE_KEYS.highlightAnnotationPrefix,
  APP_SETTINGS_STORAGE_KEYS.longClozeFrontGuardMode,
  APP_SETTINGS_STORAGE_KEYS.longClozeFrontGuardSelectionMin,
  APP_SETTINGS_STORAGE_KEYS.longClozeFrontGuardFrontMax,
  ...
  APP_SETTINGS_STORAGE_KEYS.pdfReadingMode,
  APP_SETTINGS_STORAGE_KEYS.readingLineHeight,
  APP_SETTINGS_STORAGE_KEYS.readingContentWidth,
  APP_SETTINGS_STORAGE_KEYS.dimImagesInDarkMode,
  APP_SETTINGS_STORAGE_KEYS.fontColor,
  ...
  APP_SETTINGS_STORAGE_KEYS.fontColorDark,
  APP_SETTINGS_STORAGE_KEYS.accentColorDark,
  APP_SETTINGS_STORAGE_KEYS.selectionColorDark,
  APP_SETTINGS_STORAGE_KEYS.highlightColorDark,
  APP_SETTINGS_STORAGE_KEYS.clozeColorDark,
  ...
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceGeneratorMode,
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceRecommendationId,
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceAutoSeed,
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceAutoOptions,
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceRandomHistory,
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceFavorites,
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceGeneratorModeDark,
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceRecommendationIdDark,
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceAutoSeedDark,
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceAutoOptionsDark,
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceRandomHistoryDark,
  APP_SETTINGS_STORAGE_KEYS.workspaceSurfaceFavoritesDark,
  ...
  APP_SETTINGS_STORAGE_KEYS.virtualSectionHeight,
  ...
  APP_SETTINGS_STORAGE_KEYS.rightSidebarPanelOrder,
  APP_SETTINGS_STORAGE_KEYS.importManagementActivePage,
