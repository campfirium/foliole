...
export const DEFAULT_APP_COMMAND_SHORTCUTS: DefaultCommandShortcuts = {
  ...
  [APP_COMMAND_IDS.revealReviewAnswer]: { primary: { key: ' ' }, secondary: { key: 'f' } },
  [APP_COMMAND_IDS.gradeReviewAgain]: { primary: { key: '1' } },
  [APP_COMMAND_IDS.gradeReviewHard]: { primary: { key: '2' } },
  [APP_COMMAND_IDS.gradeReviewGood]: { primary: { key: '3' }, secondary: { key: ' ' }, tertiary: { key: 'f' } },
  ...
  [APP_COMMAND_IDS.readingReviewRead]: { primary: { key: 'f' }, secondary: { key: ' ' }, tertiary: { key: '3' } },
  [APP_COMMAND_IDS.readingReviewDismiss]: { primary: { key: 'r' }, secondary: { key: '4' } },
