...
export const DEFAULT_PDF_READING_MODE: PdfReadingMode = 'warm';
export const DEFAULT_READING_LINE_HEIGHT: ReadingLineHeight = 1.75;
export const DEFAULT_READING_PARAGRAPH_SPACING: ReadingParagraphSpacing = 0.75;
export const DEFAULT_DIM_IMAGES_IN_DARK_MODE = true;
