...
describe('live Markdown formula cloze selection', () => {
  ...
  it('creates a region when dragging from formula coordinates even if the event target is the wrapper', async () => {
  ...
  it('keeps formula region creation available before presentation state is registered', async () => {
