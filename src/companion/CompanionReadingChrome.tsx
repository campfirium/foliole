...
export function ReadingChrome(props: {
  ...
  return (
    <>
      <div className="fixed inset-x-0 top-0 z-workspace-overlay bg-companion-base/95 px-4 pb-3 pt-[max(env(safe-area-inset-top),12px)] backdrop-blur">
      ...
      <div className="fixed right-5 bottom-[max(env(safe-area-inset-bottom),20px)] z-workspace-overlay flex items-center gap-2">
