...
final class FolioleCompanionSyncGroupProviderState {
    ...
    static Runtime stopped() { return new Runtime(null, null); }

    static Runtime running(
        FolioleCompanionSyncGroupServer server, FolioleCompanionNsdAdvertisement advertisement
    ) {
        return new Runtime(server, advertisement);
    }

    static final class Runtime {
        private final FolioleCompanionSyncGroupServer server;
        private final FolioleCompanionNsdAdvertisement advertisement;
