...
const IPC_SYNC_GROUP_JOIN_REQUESTS_CHANGED_CHANNEL = 'foliole:sync-group-join-requests-changed';
const IPC_SYNC_GROUP_OVERVIEW_CHANGED_CHANNEL = 'foliole:sync-group-overview-changed';
...
const SUBSCRIBABLE_CHANNELS = new Set([
  ...
  IPC_SYNC_GROUP_JOIN_REQUESTS_CHANGED_CHANNEL, IPC_SYNC_GROUP_OVERVIEW_CHANGED_CHANNEL, IPC_SYNC_GROUP_DISCOVERY_CHANGED_CHANNEL, IPC_EXTERNAL_DOCUMENT_FILE_OPENED_CHANNEL, IPC_ASSISTANT_TURN_EVENT_CHANNEL,
...
const electronApi = {
  ...
  onSyncGroupOverviewChanged: (handler) => subscribe(IPC_SYNC_GROUP_OVERVIEW_CHANGED_CHANNEL, handler),
