...
export const GLOBAL_CAPTURE_PANEL_HINT_VISIBLE_CHANNEL = 'foliole:global-capture-panel:hint-visible';
export const GLOBAL_CAPTURE_TOAST_OPEN_CHANNEL = 'foliole:global-capture-toast:open';
export const GLOBAL_CAPTURE_TOAST_TARGET_CHANNEL = 'foliole:global-capture-toast:target';
