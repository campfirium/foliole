...
const PAGE = `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>{{title}}</title><link rel="alternate" type="application/rss+xml" href="{{depth}}rss.xml"><link rel="stylesheet" href="{{depth}}style.css"></head><body><main><article><h1>{{title}}</h1>{{fields}}{{content}}</article></main><span class="hint">Space · Shift+Space · Esc</span><script>window.__archive={{archiveUrl}};window.__newer={{newerUrl}};window.__older={{olderUrl}};</script><script src="{{depth}}site.js"></script></body></html>`;
const ARCHIVE = `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>{{title}}</title><link rel="stylesheet" href="style.css"></head><body><main><h1>{{title}}</h1><ol class="archive">{{content}}</ol></main></body></html>`;
