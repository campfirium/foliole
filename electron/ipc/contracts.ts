...
export const IPC_SYNC_GROUP_JOIN_REQUESTS_CHANGED_CHANNEL = 'foliole:sync-group-join-requests-changed';
export const IPC_SYNC_GROUP_OVERVIEW_CHANGED_CHANNEL = 'foliole:sync-group-overview-changed';
