...
public class FolioleCompanionSyncPlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    public let pluginMethods: [CAPPluginMethod] = [
        ...
        CAPPluginMethod(name: "prepareAttachmentRetirement", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "finishAttachmentRetirement", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "finalizeAttachmentRetirement", returnType: CAPPluginReturnPromise),
