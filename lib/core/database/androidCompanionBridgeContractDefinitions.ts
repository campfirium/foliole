import {
  ANDROID_COMPANION_PAIRING_BRIDGE_CONTRACT_DEFINITIONS
} from './androidCompanionPairingBridgeContractDefinitions.js';
import {
...
export const ANDROID_COMPANION_BRIDGE_CONTRACT_DEFINITIONS = {
  ...
  pairingPlugin: ANDROID_COMPANION_PAIRING_BRIDGE_CONTRACT_DEFINITIONS,
  resourcePlugin: {
