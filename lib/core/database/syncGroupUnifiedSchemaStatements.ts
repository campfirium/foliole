...
export const UNIFIED_SYNC_GROUP_SCHEMA_STATEMENTS = [
  ...
  `CREATE TABLE sync_group_join_applications (
    ...
    application_public_key TEXT NOT NULL,
    library_facts_json TEXT NOT NULL,
    protocol_version INTEGER NOT NULL CHECK (protocol_version = 4),
    state TEXT NOT NULL CHECK (state IN ('waiting', 'pending', 'approved', 'rejected')),
    created_at TEXT NOT NULL,
    updated_at TEXT NOT NULL
  )`,
  ...
  `CREATE TABLE sync_group_route_grants (
    ...
    request_id TEXT NOT NULL REFERENCES sync_group_join_applications(request_id),
    group_id TEXT NOT NULL,
    timeline_id TEXT NOT NULL,
    local_member_id TEXT NOT NULL,
    peer_member_id TEXT NOT NULL,
    ...
    encrypted_route_secret_json TEXT NOT NULL,
  ...
  `CREATE TABLE sync_group_departure_outbox (
    ...
    timeline_id TEXT NOT NULL,
    member_id TEXT NOT NULL,
    kind TEXT NOT NULL CHECK (kind IN ('leave', 'revoke', 'retire')),
    roster_revision INTEGER NOT NULL,
