...
export const NATIVE_COMMANDS = {
  ...
  loadSplitTopicPreferences: 'load_split_topic_preferences',
  ...
  openSyncGroupLocalNetworkSettings: 'open_sync_group_local_network_settings',
  ...
  loadNodeTextAlternativePreview: 'load_node_text_alternative_preview',
  dismissNodeTextAlternative: 'dismiss_node_text_alternative',
  promoteNodeTextAlternative: 'promote_node_text_alternative',
  ...
  loadDatabaseSpaceStatus: 'load_database_space_status',
  loadBackupSettings: 'load_backup_settings',
  loadBackupRetentionStatus: 'load_backup_retention_status',
  startBackupSearch: 'start_backup_search',
  nextBackupSearch: 'next_backup_search',
  cancelBackupSearch: 'cancel_backup_search',
  ...
  acceptSyncGroupJoinRequest: 'accept_sync_group_join_request',
  rejectSyncGroupJoinRequest: 'reject_sync_group_join_request',
