...
export interface SyncDiagnosticContent {
  ...
  missing_image_attachment_resource_bytes?: number;
  missing_image_attachment_resource_count?: number;
  missing_other_attachment_resource_bytes?: number;
  missing_other_attachment_resource_count?: number;
  missing_pdf_attachment_resource_bytes?: number;
