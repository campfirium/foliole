...
Wersje alpha są dostępne dla macOS, Windows i Linuxa (wersja eksperymentalna).<br>
Wersje na Androida i iOS są planowane na sierpień.<br>
...
[Otwórz demo online](https://foliole.app/en/demo/)
