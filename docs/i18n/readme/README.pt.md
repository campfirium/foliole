...
As builds alpha para macOS e iOS são esperadas por volta de agosto.<br>
Você também pode experimentar o Foliole com a [demo online](https://foliole.app/pt/demo/).
...
[Abrir demo online](https://foliole.app/pt/demo/)
